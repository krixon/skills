...
**Use the project's domain vocabulary (per [../CONVENTIONS.md](../CONVENTIONS.md)) for the domain, and [LANGUAGE.md](LANGUAGE.md) vocabulary for the architecture.** If the vocabulary defines "Order," talk about "the Order intake module" — not "the FooBarHandler," and not "the Order service."
