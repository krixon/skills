...
When a term is resolved, update `CONTEXT.md` right there. Don't batch — capture them as they happen. Use the format in [../contracts/context.md](../contracts/context.md).
...
If any of the three is missing, skip the ADR. Use the format in [../contracts/adr.md](../contracts/adr.md).
