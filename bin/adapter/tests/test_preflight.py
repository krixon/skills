...
class TestCheckSubstrate(unittest.TestCase):
    ...
    def test_missing_git_is_named(self) -> None:
    ...
    def test_python_below_floor_is_named(self) -> None:
        with mock.patch("adapter.preflight.shutil.which", return_value="/usr/bin/x"):
    ...
    def test_all_missing_each_named(self) -> None:
    ...
    def test_subset_required_ignores_unlisted_tool(self) -> None:
...
class TestPreflight(unittest.TestCase):
    ...
    def test_all_present_returns_zero_and_is_silent(self) -> None:
        err = io.StringIO()
        with mock.patch("adapter.preflight.shutil.which", return_value="/usr/bin/x"):
    ...
    def test_missing_tool_returns_nonzero(self) -> None:
        err = io.StringIO()
        with mock.patch("adapter.preflight.shutil.which", return_value=None):
            rc = preflight.preflight(python_version=(3, 11), stream=err)
        self.assertNotEqual(rc, 0)

    def test_missing_tool_emits_named_halt_envelope(self) -> None:
        err = io.StringIO()
