...
class TestSlugify(unittest.TestCase):
    ...
    def test_em_dash_becomes_separator(self):
    ...
    def test_en_dash_becomes_separator(self):
    ...
    def test_caps_length_at_word_boundary(self):
    ...
    def test_single_long_word_is_hard_truncated(self):
        slug = slugify("x" * 80)
...
class TestBranchName(unittest.TestCase):
    ...
    def test_issue_none_is_no_issue_form(self):
        self.assertEqual(branch_name("feat", "csv export", issue=None), "feat/csv-export")

    def test_issue_accepts_string(self):
    ...
    def test_normalises_title_in_branch(self):
        self.assertEqual(
