...
Issues tracked in GitHub repo `krixon/skills` via the `gh` CLI. See `docs/agents/issue-tracker.md`.

### Triage labels

Seven canonical state roles; each label string equals its role name (defaults). See `docs/agents/triage-labels.md`.
