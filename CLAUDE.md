...
- `skills/CONVENTIONS.md` — the overridable convention point naming where a project's domain vocabulary, recorded decisions, and rejected scope live (with this repo's layout as the defaults), plus the consult-and-degrade-gracefully rule; skills reference it instead of hard-coding paths.
...
Where the project's domain vocabulary, decisions, and rejected scope live, and the consult-and-degrade rule skills follow: `skills/CONVENTIONS.md`.
